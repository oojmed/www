...
before using the Oojmed website or any affiliated services (the "Service") operated by Oojmed
("us", "we", or "our").
...
not owned or controlled by Oojmed.

Oojmed has no control over, and assumes no responsibility for, the content,
privacy policies, or practices of any third party web sites or services. You
further acknowledge and agree that Oojmed shall not be responsible or liable,
